...
<style>
  header{display:flex;gap:20px;align-items:start;border-bottom:1px solid var(--border);padding-bottom:24px}h1{font-size:28px;font-weight:900}header p{color:var(--text-2)}.joined{font-size:13px}.bio{margin-top:12px}.stats,.buttons{display:flex;flex-wrap:wrap;gap:12px;margin-top:15px}.stats button,.stats span{color:var(--text-2);font-size:13px}.stats b{color:white}.buttons>a,.buttons>button{border:1px solid var(--border);border-radius:999px;padding:9px 16px;font-weight:700}h2{margin:24px 0 14px;font-size:21px;font-weight:800}.grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.empty{padding:70px 0;color:var(--text-2);text-align:center}.compact{padding:20px}.people{display:grid;gap:8px}.people article,.people a{display:flex;align-items:center;gap:10px}.people article{justify-content:space-between}.people span{display:grid}.people small{color:var(--text-2)}@media(min-width:720px){.grid{grid-template-columns:repeat(4,minmax(0,1fr))}}@media(max-width:560px){.shell{padding-top:24px}header{display:grid;justify-items:center;gap:12px;text-align:center}header>div{display:grid;width:100%;justify-items:center}h1{font-size:27px}.bio{max-width:320px}.stats{display:grid;width:100%;grid-template-columns:repeat(3,minmax(0,1fr));gap:0;border-top:1px solid var(--border);border-bottom:1px solid var(--border);padding:12px 0}.stats button,.stats span{display:grid;gap:2px;padding:0 5px}.stats button+button,.stats span{border-left:1px solid var(--border)}.stats b{font-size:19px}.buttons{display:grid;width:100%;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px}.buttons>a:only-child{grid-column:1/-1}.buttons>a,.buttons>button{display:flex;min-height:44px;align-items:center;justify-content:center;padding:9px 12px}.grid{grid-template-columns:1fr;gap:14px}h2{font-size:24px}}
</style>
