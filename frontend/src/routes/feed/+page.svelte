...
<svelte:head><title>Лента | LearnFlow</title></svelte:head>
<section class="shell py-8">
  <header><div><p>LearnFlow</p><h1>Лента видео</h1></div><a href="/search">Поиск</a></header>
  {#if loading}
    <div class="state">Загружаем видео...</div>
