<script>
  ...
  import { Bookmark, Heart, MessageCircle, Plus, Send, Share2, Volume2, VolumeX, X } from 'lucide-svelte';
...
<section class="jq-page">
  <header class="mobile-head"><a href="/jq"><JarqLogo /></a><a class="add" href="/upload"><Plus size={19} /> Создать JQ</a></header>
  {#if loading}
