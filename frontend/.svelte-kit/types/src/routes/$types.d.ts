...
type LayoutRouteId = RouteId | "/" | "/courses" | "/courses/[slug]" | "/dashboard" | "/feed" | "/login" | "/messages" | "/notifications" | "/profile/[username]" | "/register" | "/search" | "/settings" | "/upload" | "/video/[slug]" | null
type LayoutParams = RouteParams & { slug?: string | undefined; username?: string | undefined }
