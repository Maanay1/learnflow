	...
	*/
	Icon($$renderer, spread_props([
		...
		sanitize_props($$props),
		{
			...
			*
			*/
			iconNode: [["path", { "d": "M14 9a2 2 0 0 1-2 2H6l-4 4V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2z" }], ["path", { "d": "M18 9h2a2 2 0 0 1 2 2v11l-4-4h-6a2 2 0 0 1-2-2v-1" }]],
			children: ($$renderer) => {
				$$renderer.push(`<!--[-->`);
